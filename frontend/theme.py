...
PALETTES = {
    ...
    # 2. Старая проверенная холодная темная тема
    "dark_classic": {
        "bg":          "#1e1f24",
        "bg_sidebar":  "#17181c",
        "bg_card":     "#262833",
        ...
        "text_dim":    "#9aa0b5",
        "accent":      "#8b93f8",
        "accent_soft": "rgba(139, 147, 248, 0.15)",
        "green":       "#41c46f",
        "yellow":      "#f2b63c",
        "red":         "#e5484d",
        "btn_hover":   "#383c43",
        "preview_bg":  "#131417",
        "toast_bg":    "rgba(33, 36, 41, 246)",
    },
    # 3. Светлая тема (высококонтрастная, теплая бумага)
    "light": {
        "bg":          "#f7f6f3",  # мягкий цвет светлой бумаги
        "bg_sidebar":  "#eeece6",  # чуть темнее для четкого разделения
        "bg_card":     "#ffffff",  # чистые белые карточки
        "bg_hover":    "#e4e1d8",  # заметный ховер
        "stroke":      "#d6d2c4",  # четкие мягкие границы карточек
        "text":        "#1c1917",  # глубокий угольный текст (максимальная читаемость!)
        "text_dim":    "#57534e",  # контрастный вторичный текст (больше не блеклый)
